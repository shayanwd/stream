...
import WillWatchCards from './WillWatchCards'
    ...
    return (
        <div className="main-modal-container">
            ...
            <div className="modal-content-box">
                ...
                setShareModal(false)
                closeModal()
            }} type="button" className="modal-close mb-5">
                ...
                <h3 className='text-center anton text-[24px] md:text-[32px]  font-[400] text-white'>Which Will You Watch?</h3>
